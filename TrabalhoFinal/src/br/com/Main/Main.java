...
//		inicarSet();
	...
	public static void iniciarList(){
		...
		list.addItem(new Product(1, "Produto 1", (double) 1), 11);
		list.addItem(new Product(2, "Produto 2", (double) 2), 12);
		list.addItem(new Product(3, "Produto 3", (double) 3), 13);
	...
	public static void inicarSet(){
		...
		set.addItem(new Product(1, "Produto 1", (double) 1), 11);
		set.addItem(new Product(2, "Produto 2", (double) 2), 12);
		set.addItem(new Product(3, "Produto 3", (double) 3), 13);
	...
	public static void inicarMap(){
		...
		map.addItem(new Product(1, "Produto 1", (double) 1), 11);
		map.addItem(new Product(2, "Produto 2", (double) 2), 12);
		map.addItem(new Product(3, "Produto 3", (double) 3), 13);
